...
export function Main() {
  ...
  const onSelectInput: FormEventHandler<HTMLSelectElement> = (event) => {
    if (event.target instanceof HTMLSelectElement) setActiveTab(event.target.value);
  };
